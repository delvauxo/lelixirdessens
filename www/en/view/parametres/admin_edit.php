  ...
  <div class="accordion-group">
    ...
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        ...
        <?php echo $this->Form->input('title_for_layout_nl','Titre Néerlandais'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <div id="collapseThree" class="accordion-body collapse">
      <div class="accordion-inner">
        ...
        <?php echo $this->Form->input('description_for_layout_nl','Description Néerlandais', array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
      </div>
    </div>
  </div>
</div>
