...
<form action="<?php echo Router::url('admin/carte/edit/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
<!-- Collapse FORM
================================================== -->
<div class="accordion" id="accordion2" style="width: 100%;">
  <div class="accordion-group">
    ...
    <div id="collapseOne" class="accordion-body collapse in">
      <div class="accordion-inner">
        <?php echo $this->Form->input('nom_fr','Titre Francais'); ?>
        <?php echo $this->Form->input('nom_en','Titre Anglais'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
      <span class="illustration">&#xe00e;</span>
      <span class="titleslide">Description</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('description_fr','Texte Francais',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
        <?php echo $this->Form->input('description_en','Texte Anglais',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <div id="collapseThree" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php  $choose = array(1 => 'Entrée', 2 => 'Pâtes', 3 => 'Poisson', 4 => 'Viande', 5 => 'Dessert' ); ?>
        <?php echo $this->Form->input('type','Entrée, Plat ou Dessert...',array('options' => $choose)); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseFour">
      ...
      <span class="titleslide">Prix</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
  ...
  <div style="text-align: right;">
    ...
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/carte/index'); ?>'">Annuler</button>
  </div>
</form>
