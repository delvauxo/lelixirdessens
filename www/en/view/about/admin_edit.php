...
<form action="<?php echo Router::url('admin/about/edit/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
...
<div class="accordion" id="accordion2" style="width: 100%;">
  <div class="accordion-group">
    ...
    <div id="collapseOne" class="accordion-body collapse in">
      <div class="accordion-inner">
        <?php echo $this->Form->input('description','Francais',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
        <?php echo $this->Form->input('description_nl','Neerlandais',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
      </div>
    </div>
  </div>
</div>
  ...
  <div style="text-align: right;">
    ...
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/about/index'); ?>'">Annuler</button>
  </div>
</form>
