...
<div style="padding: 20px;">
  <h1><span class="edit">&#x41;</span>Prix des menus de groupe:</h1>
              

<form action="<?php echo Router::url('admin/prix/edit/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
<!-- Collapse FORM
================================================== -->
<div class="accordion" id="accordion2" style="width: 100%;">
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
      ...
      <span class="titleslide">Menu Entier</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseOne" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('prix','Prix Menu Entier'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
      <img class="illustrationPrix" src="<?php echo Router::webroot('img/layout/backoffice/euro.png'); ?>">
      <span class="titleslide">Menu Sans Dessert</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('prix_ss_dessert','Prix Menu sans Dessert'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">
      <img class="illustrationPrix" src="<?php echo Router::webroot('img/layout/backoffice/euro.png'); ?>">
      <span class="titleslide">Menu sans Entrée</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseThree" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('prix_ss_entree','Prix Menu sans Entree'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
  ...
  <div style="text-align: right;">
    ...
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/prix/index'); ?>'">Annuler</button>
  </div>
</form>
