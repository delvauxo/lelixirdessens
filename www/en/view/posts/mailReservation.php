...
return true;
...

	{
		...
		echo "<br/>Here are your details :<br/><br/>
		...
		echo "<br/>	Service : <b>$service</b><br/>
					...
					Number of persons : <b>$nb_pers</b><br/>

					Date of booking : <b>$ladate_fr</b><br/>

					Reservation time : <b>$heure</b><br/><br/>";
		...
		echo "Your Message :<br/>
					...
					has been sent to the following address :<br/>
    	...
    	<div class="row">
        	...
        	<div class="col-md-12">
                ...
                <div class="description-section text-center">
                    ...
                    <p>Thank you, we took good reception of your booking request. The restaurant will confirm this reservation as soon as possible. Please check your contact information below to be able to contact you.</p>
