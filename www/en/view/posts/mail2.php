    	...
    	<div class="row">
        	<div class="col-md-12">
                ...
                <div class="description-section text-center">
                    <p>ENGLISH Merci, nous avons pris bonne réception de votre demande de contact. Le restaurant vous répondra dans les plus brefs délais. Veuillez vérifier ci-dessous vos informations de contact que vous nous avez transmis afin d'être en mesure de pouvoir vous recontacter.</p>
                </div>
            </div>
        </div>
