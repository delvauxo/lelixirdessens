        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="description-section text-center">
                    <p>Here is the lunch of the week</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div>
                    <div class="section-content" style="text-align: center;">
                        <?php $urlEn = str_replace('/en', '/fr', BASE_URL); ?>
                        <?php $count = count($lunch); ?>
                        <?php for ($i=0; $i < $count; $i++) { ?>
                            <iframe style="height: 1000px; width: 60%;" src="<?= url_actuelle().$urlEn.DS.'webroot/pdf'.DS.$lunch[$i]->file; ?>"></iframe>
                        <?php } ?>
                    </div>
                </div>
            </div>
