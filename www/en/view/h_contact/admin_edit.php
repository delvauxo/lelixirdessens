...
<!-- Collapse FORM
================================================== -->
              <form action="<?php echo Router::url('admin/h_contact/edit/'.$id); ?>" method="post" onSubmit="uploading();">
              ...
              <div class="accordion" id="accordion2" style="width: 100%;">
                ...
                <div style="text-align: right;">
                  ...
                  <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/h_contact/index'); ?>'">Annuler</button>
                </div>
              </form>
            </div>
          </div>
