...
<form action="<?php echo Router::url('admin/h_apropos/edit/'.$id); ?>" method="post" onSubmit="uploading();">
...
<div class="accordion" id="accordion2" style="width: 100%;">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('texte','Texte',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <div id="collapseThree" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('link','Link'); ?>
      </div>
    </div>
  </div>
</div>
  ...
  <div style="text-align: right;">
    ...
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/h_apropos/index'); ?>'">Annuler</button>
  </div>
</form>
