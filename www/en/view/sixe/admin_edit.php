...
<div style="padding: 20px;">
  <h1><span class="edit">&#x41;</span>Editer un sixe :</h1>
  ...
  <div class="accordion-group">
    ...
    <div id="collapseOne" class="accordion-body collapse in">
      <div class="accordion-inner">
        ...
        <?php echo $this->Form->input('titre_en','Titre NL'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        ...
        <?php echo $this->Form->input('texte_en','Texte Neerlandais',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseFour" class="accordion-body collapse">
      ...
      <div style="text-align: right;">
        ...
        <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/sixe/index'); ?>'">Annuler</button>
      </div>
</form>
