...
class Controller{
	...
	public $layout    = 'yaman';  // Layout à utiliser pour rendre la vue
	...
	**/
	function __construct($request = null){
		...
		$this->FormFront 		= new FormFront($this); 
		$this->FormBackAide 	= new FormBackAide($this); 
		$this->FormReservation 	= new FormReservation($this); 
