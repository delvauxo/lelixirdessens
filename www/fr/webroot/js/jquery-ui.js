...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		dayNames: ["Samedi", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Dimanche"], // For formatting
		dayNamesShort: ["Sam", "Lun", "Mar", "Mer", "Jeu", "Ven", "Dim"], // For formatting
		dayNamesMin: ["Sa","Lu","Ma","Me","Je","Ve","Di"], // Column headings for days starting at Sunday
