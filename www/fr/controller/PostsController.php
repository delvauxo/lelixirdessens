...
class PostsController extends Controller{
	...
	**/
	...
	function index(){
		...
		$d['parametres'] = $this->Parametre->find(array(
			'fields'     => 'Parametre.id,Parametre.title_for_layout_fr,Parametre.title_for_layout_en,Parametre.description_for_layout_fr,Parametre.description_for_layout_en',
			'order' 	 => 'id ASC',
		));
		$this->set($d);
	}
	...
	* Permet d'obtenir la methode actualité du controller posts
	...
	* Permet d'obtenir la methode vins du controller posts
	...
	* Permet d'obtenir la methode fetes du controller posts
	...
	**/
	...
	function fetes(){
		...
		$d['prix'] = $this->Pri->find(array(
			...
			'fields'		=> 'Pri.id,Pri.online,Pri.date,Pri.created,Pri.prix_ss_dessert,Pri.prix_ss_entree,Pri.prix,Pri.nom',
...
//		$d['page'] = ceil($d['total'] / $perPage);	
	...
	* Affiche la page pour les fetes...

	**/

	function admin_fetes(){
