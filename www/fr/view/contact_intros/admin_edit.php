...
<div style="padding: 20px;">
  <h1><span class="edit">&#x41;</span>Editer un texte :</h1>

<form action="<?php echo Router::url('admin/contact_intros/edit/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
...
<div class="accordion" id="accordion2" style="width: 100%;">
  <div class="accordion-group">
    ...
    <div id="collapseOne" class="accordion-body collapse in">
      <div class="accordion-inner">
        <?php echo $this->Form->input('texte_fr','Francais',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
        <?php echo $this->Form->input('texte_en','Neerlandais',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
      </div>
    </div>
  </div>
</div>
  ...
  <div style="text-align: right;">
    ...
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/contact_intro/index'); ?>'">Annuler</button>
  </div>
</form>
