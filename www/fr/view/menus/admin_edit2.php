...
<form action="<?php echo Router::url('admin/menus/edit2/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
<!-- Collapse FORM
================================================== -->
<div class="accordion" id="accordion2" style="width: 100%;">
  <div class="accordion-group">
    ...
    <div id="collapseOne" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('nom','Nom FR'); ?>
        <?php echo $this->Form->input('nom_en','Nom EN'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php  $chooseType = array(1 => 'Boissons', 2 => 'Entrée 1', 5 => 'Entrée 2', 3 => 'Plats', 4 => 'Desserts'); ?>
        <?php echo $this->Form->input('type','Type',array('options' => $chooseType)); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
  ...
  <div style="text-align: left; float: left;">
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/posts/index2'); ?>'">Prévisualiser</button>
  </div>
  <div style="text-align: right;">
    <button type="submit">Enregistrer</button>
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/menus/index2'); ?>'">Annuler</button>
  </div>
</form>
