...
<div style="padding: 20px;">
  <h1><span class="edit">&#x41;</span><?php echo isset($post->file)?'Editer':'Ajouter'; ?> un élément au menu :</h1>
              

<form action="<?php echo Router::url('admin/menus/edit3/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
<!-- Collapse FORM
================================================== -->
<div class="accordion" id="accordion2" style="width: 100%;">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php  $chooseType = array(6 => 'Entrée 1', 7 => 'Entrée 2', 8 => 'Entrée 3', 3 => 'Plats', 4 => 'Desserts'); ?>
  ...
  <div style="text-align: left; float: left;">
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/posts/index3'); ?>'">Prévisualiser</button>
  </div>
  <div style="text-align: right;">
    <button type="submit">Enregistrer</button>
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/menus/index3'); ?>'">Annuler</button>
  </div>
</form>
