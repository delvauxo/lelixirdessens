					  ...
					  <div class="box-text">
							...
							<table>
								...
								<tr>
									...
									<td onclick="JavaScript:document.location='<?php echo Router::url('admin/prix/index'); ?>'" class="mainrow"><span><?php echo $k+1; ?>&nbsp;|&nbsp;Prix [<?php echo $v->nom; ?>]</span><br /><span class="date">Date de dernière modification : <?php echo $ladate_fr_antislash; ?></span></td>
