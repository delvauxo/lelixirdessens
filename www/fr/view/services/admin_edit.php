...
<div style="padding: 20px;">
  <h1><span class="edit">&#x41;</span><?php echo isset($post->file)?'Editer':'Ajouter'; ?> un service :</h1>
              

<form action="<?php echo Router::url('admin/services/edit/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
<!-- Collapse FORM
================================================== -->
<div class="accordion" id="accordion2" style="width: 100%;">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseThree" class="accordion-body collapse">
      <div class="accordion-inner">
        ...
        <?php echo $this->Form->input('texte_en','Texte Anglais',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
      </div>
    </div>
  </div>
</div>
  ...
  <div style="text-align: right;">
    ...
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/services/index'); ?>'">Annuler</button>
  </div>
</form>
