...
<div style="padding: 20px;">
  <h1><span class="edit">&#x41;</span><?php echo isset($post->file)?'Editer':'Ajouter'; ?> un projet :</h1>
  

<form action="<?php echo Router::url('admin/portfolio/edit/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
<!-- Collapse FORM
================================================== -->
<div class="accordion" id="accordion2" style="width: 100%;">
    ...
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        <div class="picinfo">
          ...
          largeur : <b>300px</b> / hauteur : <b>250px</b>
          </span>
        </div>        
  ...
  <div class="accordion-group">
    ...
    <div id="collapseFour" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('caption_fr','Légende Francais'); ?>
        <?php echo $this->Form->input('caption_en','Légende Anglais'); ?>
      </div>
    </div>
  </div>
</div>
  ...
  <div style="text-align: right;">
    ...
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/portfolio/index'); ?>'">Annuler</button>
  </div>
</form>
