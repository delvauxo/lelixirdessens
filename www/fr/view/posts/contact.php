    	...
    	<div class="row">
        	...
        	<div class="col-md-12">
                ...
                <div class="description-section text-center">
                    ...
                    <p>Pour plus d'informations concernant les réservations ou autre, veuillez prendre contact avec notre établissement par téléphone, email ou encore via notre formulaire.</p>
						...
						<div class="Contact-Form">
							...
							<form class="leave-comment contact-form" method="post" action="<?php echo Router::url('posts/mail2'); ?>" id="cform" autocomplete="on" enctype="multipart/form-data">
								...
								<div class="Contact-us">
									...
									<?= $this->FormReservation->input('nom', 'Nom de réservation'); ?>
