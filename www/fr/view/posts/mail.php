<?php
	...
	function ControleMail(&$mail)
	{
		...
		{echo "Prenom vide !"; return false;}
		if (empty($mail['eadress']))
		{echo "Email vide !"; return false;}
		if (empty($mail['phone']))
		{echo "Phone vide !"; return false;}
...
<?php $title_for_layout = 'Micro-Web - Contact' ?>
