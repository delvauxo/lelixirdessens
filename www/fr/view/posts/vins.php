...
<div class="grid_8" id="CarteTitle3">
	...
	?>
		...
		<div class="blockCarte">
			<div class="blockCarteNomSuggestion"><?php echo ucfirst($rouge[$cle]->nom); ?></div>
			<?php 
			// Si demi vaut pas 0.00 alors afficher le prix du demi
			if ($rouge[$cle]->demi != 0.00) {
				$htmlDemi = '<div class="blockCarteDemi">';
				$htmlDemi .= $rouge[$cle]->demi.'&nbsp;&euro;';
				$htmlDemi .= '</div>';
				echo $htmlDemi;
			}else{ 
			// Sinon afficher "-" au lieu du demi
			...
			<?php 
			if ($rouge[$cle]->entier != 0.00) {
			// Si demi vaut pas 0.00 alors afficher le prix de l'entier
				$htmlEntier = '<div class="blockCarteEntier">';
				$htmlEntier .= $rouge[$cle]->entier.'&nbsp;&euro;';
				$htmlEntier .= '</div>';
				echo $htmlEntier;
			}else{ 
			// Sinon afficher "-" au lieu de l'entier
...
<div class="grid_8" id="CarteTitle3">
	...
	?>
		...
		<div class="blockCarte">
			<div class="blockCarteNomSuggestion"><?php echo ucfirst($blanc[$cle]->nom); ?></div>
			<?php 
			// Si demi vaut pas 0.00 alors afficher le prix du demi
			if ($blanc[$cle]->demi != 0.00) {
				$htmlDemi = '<div class="blockCarteDemi">';
				$htmlDemi .= $blanc[$cle]->demi.'&nbsp;&euro;';
				$htmlDemi .= '</div>';
				echo $htmlDemi;
			}else{ 
			// Sinon afficher "-" au lieu du demi
			...
			<?php 
			if ($blanc[$cle]->entier != 0.00) {
			// Si demi vaut pas 0.00 alors afficher le prix de l'entier
				$htmlEntier = '<div class="blockCarteEntier">';
				$htmlEntier .= $blanc[$cle]->entier.'&nbsp;&euro;';
				$htmlEntier .= '</div>';
				echo $htmlEntier;
			}else{ 
			// Sinon afficher "-" au lieu de l'entier
...
<div class="grid_8" id="CarteTitle3">
	...
	?>
		...
		<div class="blockCarte">
			<div class="blockCarteNomSuggestion"><?php echo ucfirst($rose[$cle]->nom); ?></div>
			<?php 
			// Si demi vaut pas 0.00 alors afficher le prix du demi
			if ($rose[$cle]->demi != 0.00) {
				$htmlDemi = '<div class="blockCarteDemi">';
				$htmlDemi .= $rose[$cle]->demi.'&nbsp;&euro;';
				$htmlDemi .= '</div>';
				echo $htmlDemi;
			}else{ 
			// Sinon afficher "-" au lieu du demi
			...
			<?php 
			if ($rose[$cle]->entier != 0.00) {
			// Si demi vaut pas 0.00 alors afficher le prix de l'entier
				$htmlEntier = '<div class="blockCarteEntier">';
				$htmlEntier .= $rose[$cle]->entier.'&nbsp;&euro;';
				$htmlEntier .= '</div>';
				echo $htmlEntier;
			}else{ 
			// Sinon afficher "-" au lieu de l'entier
...
<div class="grid_8" id="CarteTitle3">
	...
	?>
		...
		<div class="blockCarte">
			<div class="blockCarteNomSuggestion"><?php echo ucfirst($champagne[$cle]->nom); ?></div>
			<?php 
			// Si demi vaut pas 0.00 alors afficher le prix du demi
			if ($champagne[$cle]->demi != 0.00) {
				$htmlDemi = '<div class="blockCarteDemi">';
				$htmlDemi .= $champagne[$cle]->demi.'&nbsp;&euro;';
				$htmlDemi .= '</div>';
				echo $htmlDemi;
			}else{ 
			// Sinon afficher "-" au lieu du demi
			...
			<?php 
			if ($champagne[$cle]->entier != 0.00) {
			// Si demi vaut pas 0.00 alors afficher le prix de l'entier
				$htmlEntier = '<div class="blockCarteEntier">';
				$htmlEntier .= $champagne[$cle]->entier.'&nbsp;&euro;';
				$htmlEntier .= '</div>';
				echo $htmlEntier;
			}else{ 
			// Sinon afficher "-" au lieu de l'entier
