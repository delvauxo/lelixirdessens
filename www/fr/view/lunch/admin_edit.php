...
<div style="padding: 20px;">
  <h1><span class="edit">&#x41;</span>Editer un lunch de la semaine :</h1>

<form action="<?php echo Router::url('admin/lunch/edit/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseOne" class="accordion-body collapse in">
      <div class="accordion-inner">
        <?php echo $this->Form->input('titre','Titre Francais'); ?>
        <?php echo $this->Form->input('titre_en','Titre Anglais'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
        ...
        <span class="titleslide">Image / Fichier</span>
        <span class="slidedown">&#xe005;</span>
      </a>
    </div>
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('file','Fichier PDF',array('type'=>'file')); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <div id="collapseFour" class="accordion-body collapse">
      ...
      <div style="text-align: right;">
        ...
        <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/lunch/index'); ?>'">Annuler</button>
      </div>
</form>
