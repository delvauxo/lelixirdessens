...
<form action="<?php echo Router::url('admin/menus/edit1/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
<!-- Collapse FORM
================================================== -->
<div class="accordion" id="accordion2" style="width: 100%;">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php  $chooseType = array(1 => 'Boissons', 2 => 'Entrées', 3 => 'Plats', 4 => 'Desserts', 5 => 'Digestifs'); ?>
  ...
  <div style="text-align: left; float: left;">
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/menus/index1'); ?>'">Prévisualiser</button>
  </div>
  <div style="text-align: right;">
    <button type="submit">Enregistrer</button>
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/menus/index1'); ?>'">Annuler</button>
  </div>
</form>
