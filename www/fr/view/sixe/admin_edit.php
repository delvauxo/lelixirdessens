...
<div style="padding: 20px;">
  <h1><span class="edit">&#x41;</span>Editer une suggestion du jour :</h1>

<form action="<?php echo Router::url('admin/sixe/edit/'.$id); ?>" method="post" enctype="multipart/form-data" onSubmit="uploading();">
