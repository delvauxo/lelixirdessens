...
<div class="accordion" id="accordion2" style="width: 100%;">
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
      ...
      <span class="titleslide">Nom</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseOne" class="accordion-body collapse in">
      <div class="accordion-inner">
        <?php echo $this->Form->input('nom','Nom du vin'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
      <span class="illustration">&#x5f;</span>
      <span class="titleslide">Type</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseTwo" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php  $chooseType = array(1 => 'Suggestion du mois', 2 => 'Vins du Patron', 3 => 'Vin Rouge', 4 => 'Vin Blanc', 5 => 'Vin Rosé', 6 => 'Champagne & Prosecco'); ?>
        <?php echo $this->Form->input('type','Type de vin',array('options' => $chooseType)); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">
      ...
      <span class="titleslide">Région</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseThree" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php  $chooseRegion = array(0 => 'Aucun',1 => 'Abruzzo',2 => 'Alto Adige', 3 => 'Basilicata', 4 => 'Campania', 5 => 'Espagne', 6 => 'Lazio', 7 => 'Lombardia', 8 => 'Marche', 9 => 'Piemonte', 10 => 'Puglia', 11 => 'Sardegna', 12 => 'Sicilia', 13 => 'Toscana', 14 => 'Umbria', 15 => 'Valtellina', 16 => 'Veneto', 17 => 'Venezie' ); ?>
        <?php echo $this->Form->input('region','Pays ou Région',array('options' => $chooseRegion)); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapse4">
      <img class="illustrationPrix" src="<?php echo Router::webroot('img/layout/backoffice/euro.png'); ?>">
      <span class="titleslide">Prix Verre</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapse4" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('verre','Prix au Verre'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseFour">
      <img class="illustrationPrix" src="<?php echo Router::webroot('img/layout/backoffice/euro.png'); ?>">
      <span class="titleslide">Prix 1/4 L</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseFour" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('quart','Prix 1/4 L'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseFive">
      <img class="illustrationPrix" src="<?php echo Router::webroot('img/layout/backoffice/euro.png'); ?>">
      <span class="titleslide">Prix 1/2 L</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseFive" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('demi','Prix 1/2 L'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseSix">
      <img class="illustrationPrix" src="<?php echo Router::webroot('img/layout/backoffice/euro.png'); ?>">
      <span class="titleslide">Prix 3/4 L</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapseSix" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('entier','Prix 3/4 L'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapse6">
      <img class="illustrationPrix" src="<?php echo Router::webroot('img/layout/backoffice/euro.png'); ?>">
      <span class="titleslide">Prix 1 L</span>
      <span class="slidedown">&#xe005;</span>
    </a>
    </div>
    <div id="collapse6" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php echo $this->Form->input('litre','Prix 1 L'); ?>
      </div>
    </div>
  </div>
  <div class="accordion-group">
    ...
    <div id="collapseSeven" class="accordion-body collapse">
      <div class="accordion-inner">
        <?php  $choose = array(1 => 'oui', -1 => 'non' ); ?>
        <?php echo $this->Form->input('online','En ligne',array('options' => $choose)); ?>
      </div>
    </div>
  </div>
</div>
  ...
  <div style="text-align: right;">
    ...
    <button type="button" onclick="JavaScript:document.location='<?php echo Router::url('admin/vins/index'); ?>'">Annuler</button>
  </div>
</form>
